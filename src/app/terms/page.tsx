...
export const metadata: Metadata = {title: "Terms of Use | Golden Horizons",description:"Terms of Use for Golden Horizons, including no professional advice, no reliance, limitation of liability, arbitration, class action waiver, affiliate disclosures, AI-assisted content, newsletter terms, and reader responsibility.",alternates: {canonical: ${siteUrl}/terms,},robots: {index: true,follow: true,},};

export default function TermsPage() {return (Golden HorizonsTerms of UseUpdated May 4, 2026
