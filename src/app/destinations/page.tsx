          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {all26.map((country, index) => (
                  <div
                    key={country.id}
                    className="bg-white rounded-sm border border-border p-5 md:p-6 flex flex-col gap-5 hover:shadow-lg transition-shadow max-w-2xl mx-auto"
                  >
