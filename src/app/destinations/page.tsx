...
const all26: CountryCard[] = [
  {
    ...
    description:
      "Stunning coastlines, rich history, and one of Europe's most affordable countries with excellent healthcare.",
  ...
  },
  {
    ...
    description:
      "Pura Vida lifestyle, excellent healthcare, stable democracy, and stunning natural beauty.",
  ...
  },
  {
    ...
    description:
      "Uses US dollar, generous pensionado discounts, modern infrastructure, and tropical climate.",
  ...
  },
  {
    ...
    description:
      "Extremely affordable, world-class medical tourism, beautiful beaches, and welcoming culture.",
  ...
  },
  {
    ...
    description:
      "Uses US dollar, diverse climates, affordable healthcare, and welcoming retirement visa program.",
  ...
  },
  {
    ...
    description:
      "Modern infrastructure, English widely spoken, excellent healthcare, and multicultural society.",
  ...
  },
  {
    ...
    description:
      "Island lifestyle, Mediterranean diet, ancient history, and affordable European living.",
  ...
  },
  {
    ...
    description:
      "Eternal spring climate in Medellin, modern cities, affordable living, and improving safety.",
  ...
  },
  {
    ...
    description:
      "Southeast Asia's best value — extraordinary food culture, beautiful coastline, and warm welcoming people.",
  ...
  },
  {
    ...
    description:
      "€100k flat tax option, free SSN healthcare for legal residents, and the world's greatest food and wine culture.",
  ...
  },
  {
    ...
    description:
      "WHO-ranked #1 healthcare globally, free via Sécurité Sociale. Unmatched quality of life across every region.",
  ...
  },
  {
    ...
    description:
      "#2 Safest country on Earth. English-speaking, spectacular natural beauty, world-class infrastructure.",
  ...
  },
  {
    ...
    description:
      "30–40% cheaper than mainland Portugal with identical D7 visa, NHR 2.0 tax benefits, and EU citizenship path.",
    benefits: ["30% Cheaper than Lisbon", "Same D7 Visa", "NHR 2.0 Tax", "EU Citizenship"],
    scores: { costOfLiving: 4, safety: 5, healthcare: 4, lifestyle: 4 },
    ilRank: "Hidden gem",
    couple: "$1,800–$2,800",
    single: "$1,100–$1,700",
  },
  {
    ...
    description:
      "Only English-speaking EU country. 15% flat tax on foreign income, 300 sunny days, and EU citizenship pathway.",
    benefits: ["English-Speaking EU", "15% Flat Tax", "300 Sunny Days", "EU Citizenship"],
    scores: { costOfLiving: 3, safety: 5, healthcare: 4, lifestyle: 5 },
    ilRank: "Top 10 International Living 2026",
    couple: "$2,500–$4,000",
    single: "$1,400–$2,200",
  },
  {
    ...
    description:
      "Only English-speaking country in Central America. Zero tax on foreign income, USD peg, and world-class diving.",
    benefits: ["English Official", "Zero Foreign Tax", "USD Peg", "World-Class Diving"],
    scores: { costOfLiving: 4, safety: 3, healthcare: 2, lifestyle: 4 },
    ilRank: "Top 15 International Living 2026",
    couple: "$1,500–$2,500",
    single: "$900–$1,500",
  },
  {
    ...
    description:
      "Paris of South America. Extraordinary USD purchasing power, world-class steak and wine, European architecture.",
    benefits: ["USD Purchasing Power", "World-Class Culture", "European Feel", "Great Food & Wine"],
    scores: { costOfLiving: 5, safety: 3, healthcare: 4, lifestyle: 4 },
    ilRank: "Not in standard rankings",
    couple: "$1,000–$2,000",
    single: "$700–$1,200",
  },
  {
    ...
    description:
      "South America's most affordable country. Sucre's perfect 63°F year-round climate and UNESCO Heritage city.",
    benefits: ["Most Affordable SA", "Perfect Sucre Climate", "USD Peg", "UNESCO Heritage"],
    scores: { costOfLiving: 5, safety: 4, healthcare: 3, lifestyle: 3 },
    ilRank: "Budget pick",
    couple: "$800–$1,400",
    single: "$600–$900",
  },
  {
    ...
    description:
      "Easiest visa in Asia at $290/year with no income requirement. USD economy and near-zero cost of living.",
    benefits: ["$290/yr Visa", "USD Economy", "No Income Req", "Angkor Wat"],
    scores: { costOfLiving: 5, safety: 4, healthcare: 3, lifestyle: 3 },
    ilRank: "Budget pick",
    couple: "$1,000–$1,800",
    single: "$700–$1,100",
  },
  {
    ...
    description:
      "Mediterranean lifestyle at budget prices. 300 sunny days, English widely spoken, low crime, and low taxes.",
    benefits: ["Mediterranean Budget", "English Spoken", "300 Sunny Days", "Low Tax"],
    scores: { costOfLiving: 4, safety: 5, healthcare: 4, lifestyle: 4 },
    ilRank: "Hidden gem",
    couple: "$1,200–$2,200",
    single: "$800–$1,400",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?w=600&q=80",
    description:
      "English-speaking Asia with no tax on foreign pensions. Deposit-only SRRV visa and US tax treaty.",
    benefits: ["English Official", "No Foreign Tax", "US Tax Treaty", "Deposit-Only Visa"],
    scores: { costOfLiving: 4, safety: 3, healthcare: 4, lifestyle: 4 },
    ilRank: "Top 15 International Living 2026",
    couple: "$1,200–$2,500",
    single: "$800–$1,500",
  },
  {
    ...
    description:
      "One of South America's easiest residency programs. Territorial tax system and USD-linked economy.",
    benefits: ["Easiest SA Residency", "Territorial Tax", "USD-Linked", "Low Cost"],
    scores: { costOfLiving: 5, safety: 4, healthcare: 3, lifestyle: 3 },
    ilRank: "76.0/100 Research Score",
    couple: "$1,200–$2,000",
    single: "$800–$1,300",
  },
  {
    ...
    description:
      "Dedicated retirement KITAS visa, Bali's world-famous lifestyle, and very affordable living across 17,000 islands.",
    benefits: ["Retirement KITAS Visa", "Bali Lifestyle", "Very Affordable", "Zero Foreign Tax"],
    scores: { costOfLiving: 5, safety: 4, healthcare: 3, lifestyle: 4 },
    ilRank: "75.0/100 Research Score",
    couple: "$1,200–$2,200",
    single: "$800–$1,400",
  },
  {
    ...
    description:
      "Cheapest country in Europe. 1-year visa-free for Americans — longest in Europe. Albanian Riviera rivals Greece.",
    benefits: ["Cheapest in Europe", "1yr Visa-Free", "Riviera Beaches", "EU Candidate"],
    scores: { costOfLiving: 5, safety: 4, healthcare: 3, lifestyle: 3 },
    ilRank: "66.0/100 Research Score",
    couple: "$930–$1,830",
    single: "$570–$1,150",
  },
  {
    ...
    description:
      "9% flat tax — one of Europe's lowest. Stunning Bay of Kotor, Adriatic coastline, and EU candidate stability.",
    benefits: ["9% Flat Tax", "Bay of Kotor", "Euro Economy", "EU Candidate"],
    scores: { costOfLiving: 4, safety: 4, healthcare: 3, lifestyle: 4 },
    ilRank: "65.0/100 Research Score",
    couple: "$1,410–$2,640",
    single: "$880–$1,660",
  },
];
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {all26.map((country, index) => (
                <div
                  key={country.id}
                  className="bg-white rounded-sm border border-border p-5 md:p-6 flex flex-col md:flex-row gap-5 md:gap-6 hover:shadow-lg transition-shadow"
                >
                  ...
                  <div className="flex-shrink-0 w-full md:w-44 h-32 rounded overflow-hidden">
                    <img
                      src={country.image}
                      alt={`${country.name} retirement destination`}
