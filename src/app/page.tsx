    ...
    <main className="mag-page">
      <div className="site">
        ...
        <nav className="nav">
          ...
          <a href="#subscribe" style={{ textDecoration: 'none', color: 'inherit' }}>Subscribe Free</a>
        </nav>
        ...
        <div className="dest-strip">
          ...
          <div className="dest-row">
            {[
              { name: 'Portugal', cost: 'from $1,800/mo', tag: 'Top Ranked', anchor: 'portugal' },
              { name: 'Panama', cost: 'from $1,600/mo', tag: 'Best Healthcare', anchor: 'panama' },
              { name: 'Mexico', cost: 'from $1,400/mo', tag: 'Most Popular', anchor: 'mexico' },
              { name: 'Vietnam', cost: 'from $1,200/mo', tag: 'Best Value', anchor: 'vietnam' },
              { name: 'Belize', cost: 'from $1,700/mo', tag: 'English Only', anchor: 'belize' },
              { name: 'Ecuador', cost: 'from $1,300/mo', tag: 'Hidden Gem', anchor: 'ecuador' },
            ].map((d) => (
              <a 
                key={d.name} 
                href={`#${d.anchor}`} 
        ...
        <div className="dest-cards-full">
          {[
            { 
              ...
              description: 'Old-world charm meets modern healthcare in coastal towns with centuries-old cafés, affordable living, and a thriving expat community.',
              highlights: ['Golden Visa program', 'Top-tier healthcare', 'English-friendly', 'Coastal & inland options']
            },
            { 
              id: 'panama',
              name: 'Panama', 
              ...
              description: 'World-class hospitals, pensionado discounts, and a tropical climate make Panama the healthcare capital for American retirees.',
              highlights: ['Pensionado visa', 'U.S. dollar economy', 'Medical tourism hub', 'Close to U.S.']
            },
            { 
              id: 'mexico',
              name: 'Mexico', 
              cost: 'from $1,400/mo', 
              tag: 'Most Popular',
              image: 'https://images.pexels.com/photos/1481105/pexels-photo-1481105.jpeg?auto=compress&cs=tinysrgb&w=800',
              description: 'Easy access, vibrant culture, and affordable living in colonial cities, beach towns, and mountain villages across the country.',
              highlights: ['Temporary resident visa', 'Low cost of living', 'Short flights home', 'Huge expat networks']
            },
            { 
              id: 'vietnam',
              name: 'Vietnam', 
              ...
              description: 'Coastal cities with French colonial architecture, incredible food, and living costs that stretch every dollar.',
              highlights: ['Ultra-low cost', 'Rich culture', 'Safe for foreigners', 'Fresh food daily']
            },
            { 
              id: 'belize',
              name: 'Belize', 
              ...
              description: 'English-speaking Caribbean paradise with reef diving, jungle adventures, and a retirement program that welcomes Americans.',
              highlights: ['English official language', 'QRP retirement visa', 'Caribbean beaches', 'No language barrier']
            },
            { 
              id: 'ecuador',
              name: 'Ecuador', 
              ...
              description: 'Mountain towns with perfect weather year-round, affordable healthcare, and a pensioner visa that's easy to get.',
              highlights: ['Eternal spring climate', 'Affordable healthcare', 'U.S. dollar', 'Retiree discounts']
            },
          ].map((dest) => (
            <div key={dest.id} id={dest.id} className="dest-card-full">
              <img src={dest.image} alt={dest.name} className="dest-card-img" />
              <div className="dest-card-content">
                <div className="dest-card-header">
                  <div>
                    <h3 className="dest-card-name">{dest.name}</h3>
                    <div className="dest-card-cost">{dest.cost}</div>
                  </div>
                  <div className="dest-card-badge">{dest.tag}</div>
                </div>
                <p className="dest-card-desc">{dest.description}</p>
                <div className="dest-card-highlights">
                  {dest.highlights.map((item, i) => (
                    <div key={i} className="dest-highlight">
