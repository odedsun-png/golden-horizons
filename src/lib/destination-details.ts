...
const destinationsData: Record<string, DestinationDetail> = {
  portugal: {
    ...
    visa: {
      ...
      description:
        "The D7 requires ~$1,400/month in passive income (pensions, Social Security, investments). It leads to a 2-year permit, renewable for 3-year periods. After 5 years you qualify for permanent residency and EU citizenship.",
      keyTakeaway:
    ...
    tax: {
      description:
        "NHR 2.0 offers new residents a 10% flat tax on foreign pension income for 10 years — far below Portugal's standard rates (up to 48%). The US-Portugal tax treaty and totalization agreement prevent double taxation on Social Security income.",
      keyTakeaway:
